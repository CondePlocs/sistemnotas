...
import FormularioProfesor from '../../../../components/forms/FormularioProfesor';

function CrearProfesorAdministrativoContent() {
  ...
  const verificarPermisos = async () => {
    try {
      ...
      const permisoResponse = await fetch(`http://localhost:3001/api/permisos/verificar/${administrativoId}/profesores`, {
        credentials: 'include',
      });
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center">
          ...
          <p className="text-gray-600 mb-6">
            No tienes permisos para registrar profesores. Contacta al director para obtener los permisos necesarios.
          </p>
          <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Registrar Profesor</h1>
                <p className="text-sm text-gray-600">Agregar nuevo profesor al sistema</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
...
export default function CrearProfesorAdministrativo() {
  return (
    <ProtectedRoute requiredRole="ADMINISTRATIVO">
      <CrearProfesorAdministrativoContent />
    </ProtectedRoute>
  );
}
